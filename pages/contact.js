...
export default function Form() {
  ...
  return (
    <div style={{
      ...
      >
        {/* <h2 style={{ fontSize: "larger" }}>THE BLOG</h2> */}
        <div style={{
          height: '100%',
          width: "100%",
          display: 'flex',

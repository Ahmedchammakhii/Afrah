...
import iteration from '@/functions/landing/portfolio';
  ...
  return (
    <div ref={container} className='wrapper' >
      ...
      <style>{`
                 ...
                 h1 { font-size: clamp(9px, 0.8vw, 11px); letter-spacing: 0.2vw;  }
                 h2 { font-size: 35px; margin-top: 1.5%; width: 50%; text-align: center; letter-spacing: 5px;  }
